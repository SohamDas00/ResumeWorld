...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white pt-30">
      <svg
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <p className="text-sm/7 mt-6">
            ResumeBuider simplifies the entire resume-building process—from structuring content to optimizing it for recruiters—so you can focus on landing interviews, not formatting documents.
          </p>
        </div>
        ...
        <div className="ml-10">
          <h2 className="font-semibold mb-5 text-stone-900">Get in touch</h2>
          <div className="text-sm space-y-2">
            <p>+91 7980290675</p>
            <p>jisusoham04@gmail.com</p>
          </div>
        </div>
      </div>
